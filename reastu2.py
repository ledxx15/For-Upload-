...
class ReservationDialogStep1(QDialog):
    ...
    def validate_inputs(self):
        ...
        self.accept()
        reservation_dialog_step2 = ReservationDialogStep2()
...
class ReservationDialogStep2(QDialog):
    def __init__(self):
        ...
        self.setGeometry(500, 320, 600, 450)  # Increased height to accommodate additional field
        ...
        self.setStyleSheet("""
            ...
            QComboBox, QSpinBox, QDateEdit {
                padding: 10px; /* Add padding to input fields */
                border: 2px solid #C0C0C0; /* Add border to input fields */
                border-radius: 5px; /* Rounded corners */
            }
        ...
        form_layout.addRow("Price:", self.price_label)  # Add price label
    ...
    def proceed_reservation(self):
        ...
        # Calculate prices
        area_prices = {"Inside Dining": 500, "Al Fresco": 500, "Balcony": 600, "Rooftop": 700, "VIP Lounge": 1000,
...
class MainWindow(QWidget):
    ...
    def initUI(self):
        ...
        self.setGeometry(100, 100, 1200, 800)  # Adjusted the window size
        ...
        reserve_button.setGeometry(500, 700, 300, 80)  # (x, y, width, height)
        reserve_button.setFont(QFont("Arial", 15))  # Set font size to 15
        ...
        reserve_button.clicked.connect(self.show_reservation_dialog_step1)  # Connect button click to method

        about_button = QPushButton("ABOUT US", self)
        about_button.setGeometry(900, 700, 300, 80)  # (x, y, width, height)
        about_button.setFont(QFont("Arial", 15))  # Set font size to 15
        ...
        about_button.clicked.connect(self.show_about_dialog)  # Connect button click to method
